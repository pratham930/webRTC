...
pc.current =_pc
  ...
  const createOffer =()=>{
    ...
    offerToReceiveAudio:1}).then(sdp=>{
...
{/* ////8888***?? */}
    ...
    <Box>
<video style={{width:200,height:240,backgroundColor:"black"}} ref={localVideoRef} autoPlay> </video>
<br/>
<video style={{width:200,height:240 ,backgroundColor:"black"}} ref={remoteVideoRef} autoPlay> </video>
